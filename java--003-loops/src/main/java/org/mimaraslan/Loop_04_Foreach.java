...
public class Loop_04_Foreach {
    public static void main(String[] args) {
        ...
        System.out.println("-- FOR3 -- STRING --- FOREACH ---------");

        for (String student:students){ //(tekil : çoğultaraf)
            System.out.println(student);
        }
        System.out.println("-- FOR3 -- INT FOREACH ---------");
        int[] arrYears = {2000,2003,2008,2017,2024};
