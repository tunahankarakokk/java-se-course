...
public class AppMain {
    public static void main(String[] args) {
        ...
        System.out.println("Student 2 - 1.Durum: "+student);
        ...
        if(student2!=null){
            ...
            System.out.println("Student 2 2.Durum :"+ student2.getIdNumber());
        }


        //--hiçlikten bişey yazmak istiyorsun atama yapmışsın nasıl yapsın


*/
        try{
            //buradaki kodu dene
            student2.setIdNumber(100);//burada ilk gördüğü hatayı bulup ekrana yazıyor ilk karşlaştığı hatayı basar çıkar.
            //student2.setFirstName("Eyşan");
            //student2.setLastName("Tezcan");
            System.out.println(student2.getIdNumber());
            System.out.println(student2.getLastName());
        }catch(Exception e){
            //hata oluştu yakaladık birşeyler
      ...
      //  System.out.println(myArray[6].toUpperCase());
        ...
        System.out.println("nullkontrol3 : " + nullKontrol3);
        System.out.println("nullkontrol3.get() : " + nullKontrol3.get());
